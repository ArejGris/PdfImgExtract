<template>
  <div class="silentbox-gallery">
    ...
    <div class="warp">
      ...
      @click.prevent="openOverlay(image, index)" class="item2" placeholder="" style="width:45px;height: 45px;"/>
                           
          
        <img src="../assets/img/closebtn.svg" class="item1" @click="removeItem($event,image.id)"/>
